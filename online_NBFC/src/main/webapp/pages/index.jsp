...
<head>
    <meta charset="utf-8">
    <title>Fortune - Financial Services </title>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-light m-0">
                            ...
                            <a href="personal" class="dropdown-item">Personal Loan</a>
                        </div>
                    </div>
                    <a href="contact" class="nav-item nav-link">Contact</a>
                     <a href="cust_login" class="nav-item nav-link">Login</a>
                </div>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p class="d-inline-block border border-white rounded text-primary fw-semi-bold py-1 px-3 animated slideInDown">Welcome to Fortune</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Your Financial Status Is Our Goal</h1>
                                    <a id="i" href="cust_signup" data-toggle="modal" data-target="cust_signup" style="">Apply for Loan Now !!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                               ...
                               <a id="i" href="cust_signup" data-toggle="modal" data-target="cust_signup" style="">Apply for Loan Now !!</a>                                </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" src="img\home1.jpg" style="height:400px">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">About Us</p>
                    <h1 class="display-5 mb-4">We Help Our Clients To Grow Their Business</h1>
                    <p class="mb-4">We at Fortune Finance believe in financing assets and economic activities that are income generating. Through this approach we ensure that the capital is put to use in enabling businesses to grow and expand.</p>
                    <div class="border rounded p-4">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                <p>To contribute to India's growth story by providing accessible financing to retail, wholesale and rural audience, thereby unleashing it's vast economic potential and spurring the country's growth to even greater heights.</p>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="bg-white border rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <form action="call_request" method="post">
                        <div class="row g-3">
                            <div class="col-sm-6">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Pune, Maharastra, INDIA</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="farmloan">Farm Equipment Loan</a>
                    <a class="btn btn-link" href="vehicle">Commercial Vehicles</a>
                    <a class="btn btn-link" href="business">Business Loan</a>
                    <a class="btn btn-link" href="personal">Personal Loan</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Fortune</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="border-bottom" href="https://htmlcodex.com">Vishwajit Jagtap</a>
                </div>
            </div>
        </div>
    </div>
