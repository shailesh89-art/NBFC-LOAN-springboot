                    ...
                    <tbody>
                     <c:forEach var="e" items="${a1}">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                         <a href="viewfile?id=${e.id}"><button style="font-size:16px; cursor:pointer;background:green;color:white;border-radius:5px;" onclick="showAlert()">Approved&nbsp;<i class="fa fa-check-square"></i></button></a>&nbsp;&nbsp;
                        <a href="delete?id=${e.id}"><button style="font-size:16px; cursor:pointer;background:red;color:white;border-radius:5px;" onclick="myFunction()">Decline&nbsp;<i class="fa fa-close"></i></i></button></a>&nbsp;&nbsp;
                        </td>
