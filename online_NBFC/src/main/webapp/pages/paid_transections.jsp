...
<body class="">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Paid Transections Details</h4>
              </div>
              <div class="card-body">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var paymentStatus = /* Obtain the payment status from your Spring Boot application */;
